...
FROM international_debt
ORDER BY distinct_debt_indicators;  -- total 25 distinct_debt_indicators
...
FROM international_debt;                                --total_debt is 3079734.49
...
ORDER BY SUM(debt) DESC;                 -- China	285,793.49 millions highest debt
